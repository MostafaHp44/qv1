...
const FavProducat = () => {
    return (
    <div className="MainFavProducat">
         <section className="h-100" style={{backgroundColor: '#eee'}}>
        <div className="container h-100 py-5">
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="col-10">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h3 className="fw-normal mb-0 text-black">Fav Producat <UilHeartAlt/> </h3>
              ...
              <div className="card">
                <div className="card-body">
                  <button type="button" className="btn btn-warning btn-block btn-lg"><Link to='/' style={{textDecoration:'none',color:'white'}}>Home</Link></button>
